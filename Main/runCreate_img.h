...
inline void createIMG(std::string id, std::string type, std::string amount, std::string balance) {
    std::string exePath = "D:/year1/1-2/Compro/project/TAM-HAA-SUAN-DOK/Main/create_img.exe";
    std::string workingDir = "D:/year1/1-2/Compro/project/TAM-HAA-SUAN-DOK/Main/";
...
inline void createSlip(std::string id1, std::string n1, std::string id2, std::string n2, std::string amount) {
    std::string exePath = "D:/year1/1-2/Compro/project/TAM-HAA-SUAN-DOK/Main/create_transfer.exe";
    std::string workingDir = "D:/year1/1-2/Compro/project/TAM-HAA-SUAN-DOK/Main/";
